...
public class SimulatedPlayer implements Access {
    ...
    public static SimulatedPlayer fromClientPlayer(MovementInput input, float yaw) {
    ...
    private boolean isRainingAt(BlockPos pos) {
        if (worldObj.getRainStrength(1.0F) <= 0.2) {
            ...
            if (base.isSnowyBiome()) return false;
