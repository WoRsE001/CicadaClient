...
import net.cicada.event.impl.ClipEvent;
import net.cicada.event.impl.StrafeEvent;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            {
                clipEvent.setPriority(Event.Priority.High);
                clipEvent.call();
                if (!clipEvent.isCanceled()) y = axisalignedbb1.calculateYOffset(this.getEntityBoundingBox(), y);
            }
            ...
            {
                clipEvent.setPriority(Event.Priority.Low);
                clipEvent.call();
                if (!clipEvent.isCanceled()) x = axisalignedbb2.calculateXOffset(this.getEntityBoundingBox(), x);
            }
            ...
            for (AxisAlignedBB axisalignedbb13 : list1)
            {
                clipEvent.setPriority(Event.Priority.High);
                clipEvent.call();
                if (!clipEvent.isCanceled()) z = axisalignedbb13.calculateZOffset(this.getEntityBoundingBox(), z);
            }
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if (f >= 1.0E-4F)
        {
            ...
            strafe = strafeEvent.getMoveStrafe() * f;
            forward = strafeEvent.getMoveForward() * f;
            float f1 = MathHelper.sin(strafeEvent.getRotationYaw() * (float)Math.PI / 180.0F);
            float f2 = MathHelper.cos(strafeEvent.getRotationYaw() * (float)Math.PI / 180.0F);
