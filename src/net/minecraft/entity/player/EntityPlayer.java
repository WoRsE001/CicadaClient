                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            double slowFactor = ModuleManager.KEEP_SPRINT.isState() ? (this.onGround ? ModuleManager.KEEP_SPRINT.slowDownOnGround.getValue() : ModuleManager.KEEP_SPRINT.slowDownInAir.getValue()) : 0.6;
                            this.motionX *= slowFactor;
                            this.motionZ *= slowFactor;
                            this.setSprinting(ModuleManager.KEEP_SPRINT.isState() && (this.onGround ? ModuleManager.KEEP_SPRINT.sprintOnGround.isValue() : ModuleManager.KEEP_SPRINT.sprintInAir.isValue()));
                        }
