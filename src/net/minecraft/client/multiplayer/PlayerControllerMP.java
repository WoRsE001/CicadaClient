...
public class PlayerControllerMP
{
    ...
    {
        AttackEvent attackEvent = new AttackEvent(playerIn, targetEntity, Event.Priority.Low).call();
        if (attackEvent.isCanceled()) return;
        ...
        attackEvent.setPriority(Event.Priority.High);
        attackEvent.call();
    }
