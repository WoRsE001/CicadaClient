...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        UpdateEvent updateEvent = new UpdateEvent().call();
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        {
            MotionEvent motionEvent = new MotionEvent(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, Event.Priority.Low).call();
            if (motionEvent.isCanceled()) return;
            ...
            if (this.ridingEntity == null) 
            {
                if (flag2 && flag3)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(motionEvent.getPosX(), motionEvent.getPosY(), motionEvent.getPosZ(), motionEvent.getRotationYaw(), motionEvent.getRotationPitch(), motionEvent.isOnGround()));
                }
                else if (flag2) 
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(motionEvent.getPosX(), motionEvent.getPosY(), motionEvent.getPosZ(), motionEvent.isOnGround()));
                } 
                else if (flag3) 
                {
