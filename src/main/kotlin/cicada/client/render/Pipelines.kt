...
val RECT_PIPELINE: RenderPipeline = register(builder(MATRICES_PROJECTION_SNIPPET)
    ...
    .withVertexFormat(RECT_FORMAT, VertexFormat.Mode.QUADS)
    .build()
)
...
val IMAGE_PIPELINE: RenderPipeline = register(builder(MATRICES_PROJECTION_SNIPPET)
    ...
    .withColorTargetState(ColorTargetState(BlendFunction.TRANSLUCENT))
    .withVertexFormat(IMAGE_FORMAT, VertexFormat.Mode.QUADS)
    .build()
)
...
val TRIANGLE_PIPELINE: RenderPipeline = register(builder(MATRICES_PROJECTION_SNIPPET)
...
val MSDF_IMAGE_PIPELINE: RenderPipeline = register(builder(MATRICES_PROJECTION_SNIPPET)
