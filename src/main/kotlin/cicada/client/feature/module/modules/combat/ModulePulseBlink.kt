...
object ModulePulseBlink : ClientModule("PulseBlink", ModuleCategory.COMBAT), PacketDelayer {
    private val delay11 by int("Delay", 500, 0..1000)
    ...
    override fun onEvent(event: Event) {
        ...
        if (event is EventGameLoop.Pre) {
            ...
            if (System.currentTimeMillis() % delay11 == 0L) {
                handleWithDelay(0)
            }
        }
    }
