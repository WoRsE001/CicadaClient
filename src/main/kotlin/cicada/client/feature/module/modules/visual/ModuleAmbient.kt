...
object ModuleAmbient : ClientModule("Ambient", ModuleCategory.VISUAL, description = "Beautifies the world") {
    private val time = toggleableGroup("Time", false)
        private val worldTime by time.float("World time", 1f, -1f..1f)
